...
# Load the pickle model file exact name
MODEL_PATH = os.path.join(os.path.dirname(__file__), 'LinearRegression_model_pkl')
...
# Exact 16 feature attributes extracted directly from your model
FEATURES = [
    ...
    {"id": "Built Year", "label": "Built Year", "default": 1995, "step": 1, "type": "int"},
    {"id": "Renovation Year", "label": "Renovation Year (0 if none)", "default": 0, "step": 1, "type": "int"},
    {"id": "living_area_renov", "label": "Living Area Renovated (sqft)", "default": 1800, "step": 10, "type": "float"},
...
<body>
    ...
    <div class="container">
        <header>
            ...
            <p>Input house specifications below to estimate market value</p>
        </header>
        ...
        <form id="predict-form">
            ...
            <button type="submit" class="btn-submit" id="submit-btn">
                <span id="btn-text">Estimate Value</span>
    ...
    <script>
        document.getElementById('predict-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                btnText.textContent = "Estimate Value";
...
def predict():
    if model is None:
        return jsonify({'status': 'error', 'error': 'Model file could not be loaded on server.'}), 500
